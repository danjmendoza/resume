...
<div id="folio" class="container tab"  style="display:none;">
	<div class="row">
		<div class="col-md-12">
			<ul class="categories">
	...
	<div class="row thumbs">
		...
		<div class="col-md-3 item wordpress">
			<a href="http://www.championpowerequipment.com" class="thumbnail" target="_blank">
				<img src="/img/portfolio/champion-power-thumb-color.png" alt="...">
			</a>
		...
		<div class="col-md-3 item wordpress">
			<a href="http://www.earthwisebags.com" class="thumbnail" target="_blank">
				<img src="/img/portfolio/earthwise-bags-thumb-color.png" alt="...">
			</a>
			Earthwise Bags
		</div>
		<div class="col-md-3 item wordpress">
			<a href="http://www.encounterbooks.com" class="thumbnail" target="_blank">
				<img src="/img/portfolio/encounter-books-thumb-color.png" alt="...">
			</a>
			Encounter Books
		</div>
		<div class="col-md-3 item wordpress">
		...
		<div class="col-md-3 item wordpress">
			<a href="http://www.gocommercialproducts.com" class="thumbnail" target="_blank">
				<img src="/img/portfolio/go-commercial-thumb-color.png" alt="...">
			</a>
			Go Commercial
		</div>
		<div class="col-md-3 item wordpress">
			<a href="http://www.rpsenvironmental.com" class="thumbnail" target="_blank">
